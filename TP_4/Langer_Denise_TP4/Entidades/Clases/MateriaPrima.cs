...
namespace Entidades
{
    public static class MateriaPrima
    {
        ...
        /// En caso de encontrar un archivo binario, settea los atributos con los valores deserializado
        /// </summary>
        static MateriaPrima()
        {
            ...
            try
            {
                CantidadPlastico = Binary.Leer(EMateriales.Plastico);
                CantidadTela = Binary.Leer(EMateriales.Tela);
                CantidadHilo = Binary.Leer(EMateriales.Hilo);
            }
            catch (Exception)
            {
            }
        ...
        public static void ComprarMateriales(EMateriales material, int cantidadUsada)
        {
            try
            {
                switch (material)

...
namespace Archivos
{
    public static class ArchivoTXT<T> : IArchivo<string>
    {
        public static bool Guardar(string pathArchivo, string datos)
        {
        ...
        public static bool Leer(string pathArchivo, out string datos)
        {
            bool agregoInfo = false;
            datos = default;

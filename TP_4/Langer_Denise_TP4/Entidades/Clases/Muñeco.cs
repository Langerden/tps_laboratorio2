...
namespace Entidades
{
    ...
    public class Muñeco : Juguete
    {
        ...
        public Muñeco(EMateriales materiales, int cantidadProduccion, string marcaProducto, string modelo, int cantidadPartes, bool llevaRopa, bool esArticulado) : this(materiales, cantidadProduccion, marcaProducto)
        {
            Modelo = modelo;

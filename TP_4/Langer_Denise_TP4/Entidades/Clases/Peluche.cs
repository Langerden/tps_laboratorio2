...
namespace Entidades
{
    ...
    public class Peluche : Juguete
    {
        ...
        public Peluche(bool isSqlObject, EMateriales materiales, int cantidadProduccion, string marcaProducto, string modelo, EColores color, int tamañoCm, EMedida medida) : this(materiales, cantidadProduccion, marcaProducto)
        {
            this.sqlObject = isSqlObject;
            Modelo = modelo;
            Color = color;
            TamañoCm = tamañoCm;
            Medida = medida;
        ...
        public int TamañoCm
        {
            ...
            set
            {
                if (this.sqlObject)
                    ...
                    this.tamañoCm = CalcularCentimetros(value, this.medida);
            }
        }
